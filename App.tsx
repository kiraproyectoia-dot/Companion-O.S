...
// FIX: Consolidate and refine global JSX intrinsic elements for standard HTML and Three.js components
declare global {
  namespace React {
    namespace JSX {
...
const App: React.FC = () => {
  ...
  return (
    <div 
      className="relative text-white min-h-screen flex flex-col items-center justify-center p-4 font-sans bg-black overflow-hidden"
    ...
    >
      ...
      <div 
        className="relative w-full max-w-5xl h-[95vh] flex flex-col bg-neutral-900/40 rounded-3xl shadow-2xl backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-700"
        onDrop={handleDrop}
      >
        <header className="flex items-center justify-between px-8 py-5 border-b border-white/5 flex-shrink-0 z-10 bg-gradient-to-b from-black/40 to-transparent">
          ...
          <Controls
              ...
              isMuted={isMuted}
              isPaused={isPaused}
              isListening={isConnected && !isPaused}
        ...
        <main className="flex flex-col flex-grow overflow-hidden relative">
          <div className="flex-grow relative min-h-0 bg-black">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className={`w-full max-w-lg aspect-square rounded-full transition-all duration-1000 blur-[120px] ${isConnected ? 'bg-purple-600/20' : 'bg-transparent'}`} />
            </div>
            ...
            {(isCameraActive || isScreenShareActive) && (
              <div className="absolute top-4 left-4 z-30 w-40 aspect-video rounded-xl border border-white/10 bg-black/60 overflow-hidden shadow-2xl">
